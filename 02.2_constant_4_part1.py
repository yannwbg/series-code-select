...
pivot_df_constant_4['discard_on_score'] = pivot_df_constant_4['discard']
...
pivot_df_constant_4['discard_on_sector'] = conditions
...
pivot_df_constant_4 = pd.merge(pivot_df_constant_4, iso_mapping_un4, on='country', how='left')
...
df_constant_4_int_discard.reset_index(inplace=True, drop=True)
print(df_constant_4_int_discard.tail(10))
