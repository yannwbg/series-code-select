...
iso_mapping_un4 = df_current_4.iloc[:, :2].drop_duplicates()
#print(iso_mapping.head())
iso_mapping_un4.to_csv("/Users/Danjing 1/Lingsu/Jobs/2024 WB STC/Sector/Process/iso_mapping_un4.csv", index=False)
...
pivot_df_current_4['discard_on_score'] = pivot_df_current_4['discard']
...
pivot_df_current_4['discard_on_sector'] = conditions
...
df_current_4_int_discard.reset_index(inplace=True, drop=True)
...
df_current_4_int = df_current_4_int.loc[:, columns_to_keep]
df_current_4_int.reset_index(inplace=True, drop=True)
print(df_current_4_int.tail(10))
